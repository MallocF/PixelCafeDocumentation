...
\newcommand{\linkSubSection}[1]{\hypertarget{Sub Section:#1}{\subsection{#1}}}
\newcommand{\linkSubSubSection}[1]{\hypertarget{Sub Sub Section:#1}{\subsubsection{#1}}}
\newcommand{\refToSection}[1]{\hyperlink{Section:#1}{#1}}
\newcommand{\refToSubSection}[1]{\hyperlink{Sub Section:#1}{#1}}
\newcommand{\refToSubSubSection}[1]{\hyperlink{Sub Sub Section:#1}{#1}}
...
\newcommand{\valueBetween}[3]{$#1\geq #2 \leq#3$}
\newcommand{\FQV}{\textbf{FQV}}
\newcommand{\FQLR}{\textbf{FQLR}}
\newcommand{\VIP}{\textcolor{yellow}{\sc{VIP}}}
...
\begin{document}
    ...
    \begin{itemize}
        \item \itemizeListDisplay{\refToSubSubSection{Party UI}}
        \item \itemizeListDisplay{\refToSubSubSection{Store UI}}
        \item \itemizeListDisplay{\refToSubSubSection{Trade UI}}
        \item \itemizeListDisplay{\refToSubSubSection{Inventory UI}}
        \item \itemizeListDisplay{\refToSubSubSection{Leaderboard / Rank UI}}
    ...
    \hypertarget{Sub Section:Jobs}{\subsection{Jobs}}
        ...
        \hypertarget{Sub Section:Food System}{\subsection{Food System}}
                \noindent \emph{Every} food in the game has one thing in common, and that is the \textcolor{noteColor}{food quality value}.
                The food quality value or \FQV is a value that tells you how well kept or fresh the food you are dealing with is. \FQV
                start off at 100\% and slowly starts dropping down, there are 4 different stages that the food can be in at any moment in time.
                And those stages are as follows:
                \begin{enumerate}
                    \item 
                        Fresh
                        \begin{itemize}
                            \item \valueBetween{85}{FQV}{100}
                        \end{itemize}
                    \item
                        \noindent Decent
                        \begin{itemize}
                            \item \valueBetween{65}{FQV}{84}
                        \end{itemize}
                    \item
                        \noindent Poor
                        \begin{itemize}
                            \item \valueBetween{20}{FQV}{64}
                        \end{itemize}
                    \item
                        \noindent Rotten
                        \begin{itemize}
                            \item \valueBetween{0}{FQV}{19}
                        \end{itemize}
                \end{enumerate}
                \vspace{2mm}

                \begin{spacing}{1.2}
                    \noindent When making food the final food product \FQV will~depend on the ingridients \FQV~
                    The final product will always have the same \FQV as the ingridients that has the \emph{lowest}
                    \FQV~overall. However one thing that isn't effect by the ingridients and it different for every product it self
                    is the \emph{Food Quality Loss Rate} or \FQLR~for short. In shots \FQLR~can be described mathematically as: \[\FQLR = \frac{\partial \FQV}{\partial t}\]
                    \noindent Your main goal is to keep \FQLR~as low as possible as to keep the \FQV~as high as long as you can. Bringing down \FQLR~to 0 is \emph{not} possible.
                    Some things that you can do to keep \FQLR~is:
                    \begin{itemize}
                        \item Keep the food in it's proper place.
                        \item Keep rooten food away from other food products.
                        \item Keep your storage space well cleaned and refrigirated.
                    \end{itemize}
                \end{spacing}
        \linkSection{Tools}
                ...
                \subsection{Dev Products}
                    ...
                    \begin{center}
                        \begin{tabular}{|c|c|c|}
                            ...
                            \displayProduct{+\$10}{10}{N.A}
                            \displayProduct{+\$100}{90}{N.A}
                            \displayProduct{+\$500}{400}{N.A}
                            \displayProduct{+\$1000}{720}{N.A}
                            \displayProduct{Extra Save Slot}{350}{N.A}
                        \end{tabular}
                    \end{center}
                    ...
                    \linkProduct{Extra Save Slot}
                        \noindent This will give players an extra save slot, they can buy this only up to 3 times.
    ...
    \subsection{Main Menu Scenary Shot}
        ...
        \begin{figure}[hb]
            \centering
            \includegraphics[width = .5\textwidth, keepaspectratio = true]{main_menu_ref.png}
            \caption{Reference image for main menu map}
            \label{Figure:Main Menu}
        \end{figure}

    \linkSection{User Interfaces}
        \subsection{Main Menu UI's}
            \linkSubSubSection{Party UI}
                \begin{multicols}{2}
                    \begin{minipage}{\columnwidth}
                        \centering
                        \includegraphics[keepaspectratio = true, width = .5\columnwidth, trim=3mm 0 0 0]{PartyPlayerList}\\
                        \vspace{1mm}
                        \noindent \textsc{Player Party Invite UI}
                    \end{minipage}

                    \begin{minipage}{\columnwidth}
                        \centering
                        \includegraphics[keepaspectratio = true, width = .8\columnwidth, trim=3mm 0 0 0]{CreatePartyUI}\\
                        \vspace{1mm}
                        \noindent \textsc{Create Party UI}
                    \end{minipage}

                    \begin{minipage}{\columnwidth}
                        \begin{spacing}{1.2}
                            \noindent Player Party Invite UI is your typical player search and inv menu. It allows you to
                            see the players Name, Display Name, Level, and max days survived. It will also tell you if they are a \VIP.
                            Right next to their avatar to the right is gonna be an invite button. If the user joins another party or leaves their avatar will get removed from the list.
                        \end{spacing}
                    \end{minipage}

                    \begin{minipage}{\columnwidth}
                        \begin{spacing}{1.2}
                            \noindent As previously described in the \textbf{\refToSection{Main Menu}} section, the party creation UI provides the player with
                            options for making their party open / closed, same with the session for their friends. Also provides the bonus options if you chose the closed party type.
                        \end{spacing}
                    \end{minipage}
                \end{multicols}
            \linkSubSubSection{Leaderboard / Rank UI}
        \subsection{Main Game UI's}

        \subsection{Mutual UI's}
            \linkSubSubSection{Store UI}
            \linkSubSubSection{Trade UI}
            \linkSubSubSection{Inventory UI}
\end{document}